...
const eventTypes = [
  { name: 'Concerts', icon: '🎤', desc: 'Global artists. Iconic venues.', color: 'from-purple-500/20 to-pink-500/20' },
  { name: 'Brand Activations', icon: '✨', desc: 'Immersive. Viral. Unforgettable.', color: 'from-blue-500/20 to-cyan-500/20' },
  { name: 'Exhibitions', icon: '🎨', desc: 'Cultural. Curated. Global.', color: 'from-green-500/20 to-emerald-500/20' },
  { name: 'Product Launches', icon: '🚀', desc: 'Maximum impact. Maximum reach.', color: 'from-orange-500/20 to-red-500/20' },
  { name: 'Corporate Events', icon: '💼', desc: 'Conferences. Galas. Networking.', color: 'from-indigo-500/20 to-purple-500/20' },
  { name: 'Fashion Shows', icon: '👗', desc: 'Runway. Luxury. Press coverage.', color: 'from-pink-500/20 to-rose-500/20' },
]

const venueHighlights = [
  { name: 'Fashion Catwalk', capacity: '500+', features: 'LED walls, Professional lighting', image: 'https://images.unsplash.com/photo-1536834478751-1a2e9e9b1f2b?w=400&q=80' },
  { name: 'Central Atrium', capacity: '1,000+', features: 'High footfall, Multi-level', image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&q=80' },
  { name: 'Waterfront Stage', capacity: '2,000+', features: 'Fountain views, Outdoor', image: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=400&q=80' },
]

const eventStats = [
  { value: '200+', label: 'Events Yearly', icon: '📅' },
  { value: '50K+', label: 'Avg Attendance', icon: '👥' },
  { value: '100+', label: 'Global Brands', icon: '🏢' },
        ...
        <div ref={ref as any}>
          ...
          <div className={`mb-10 sm:mb-12 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              ...
              <Link href="/events">
                <button className="text-xs sm:text-sm text-gray-400 hover:text-white transition">
                  View all →
                </button>
              </Link>
            </div>
          ...
          <div className={`mb-10 sm:mb-12 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              {['Chanel', 'Apple', 'Nike', 'Dior', 'Samsung', 'Rolex', 'Mercedes', 'TikTok'].map((brand, idx) => (
                <span
                  key={brand}
          ...
          <div className={`text-center transition-all duration-700 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <div className="flex items-center justify-center gap-4 mt-3 text-[10px] sm:text-xs text-gray-600">
                <span>✓ Dedicated event team</span>
                <span>✓ Production support</span>
                <span>✓ Marketing amplification</span>
              </div>
            </div>
          </div>
        </div>
