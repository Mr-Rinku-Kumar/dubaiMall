...
// Dining data with Unsplash fallback images
const diningImages = [
  { 
...
const cuisineTypes = [
  { name: 'Italian', count: 25, icon: '🍝' },
  { name: 'Japanese', count: 18, icon: '🍣' },
  { name: 'Chinese', count: 22, icon: '🥢' },
  { name: 'Indian', count: 15, icon: '🍛' },
  { name: 'French', count: 12, icon: '🥖' },
  { name: 'Mediterranean', count: 20, icon: '🫒' },
  { name: 'American', count: 30, icon: '🍔' },
  { name: 'Middle Eastern', count: 28, icon: '🧆' },
]

const diningStats = [
  { value: '200+', label: 'Restaurants', icon: '🍽️' },
  { value: '50+', label: 'Cuisines', icon: '🌍' },
  { value: '15+', label: 'Michelin Stars', icon: '⭐' },
  { value: '24/7', label: 'Dining Options', icon: '🌙' },
]
              ...
              <div className={`space-y-4 sm:space-y-6 transition-all duration-700 delay-200 ${
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {cuisineTypes.slice(0, 6).map((cuisine, idx) => (
                      <div
                        key={cuisine.name}
