...
// Luxury brands list
const luxuryBrands = [
  { name: 'Chanel', category: 'Fashion', logo: 'C' },
  { name: 'Louis Vuitton', category: 'Fashion', logo: 'LV' },
  { name: 'Gucci', category: 'Fashion', logo: 'G' },
  { name: 'Hermès', category: 'Fashion', logo: 'H' },
  { name: 'Dior', category: 'Fashion', logo: 'D' },
  { name: 'Cartier', category: 'Jewelry', logo: 'C' },
  { name: 'Rolex', category: 'Watches', logo: 'R' },
  { name: 'Prada', category: 'Fashion', logo: 'P' },
]
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className={`relative rounded-2xl overflow-hidden aspect-[4/5] transition-all duration-700 delay-100 ${
                ...
                {!imageError ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-yellow-900/30 to-black flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-400">Fashion Avenue</p>
                    </div>
                  </div>
                )}
                ...
                <div className="absolute top-4 right-4 bg-black/50 backdrop-blur rounded-full px-3 py-1">
                  <span className="text-xs text-yellow-400">✦ Premium Wing</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {[
                  ...
                  'https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?w=200&q=80',
                  ...
                  <div key={idx} className="relative rounded-lg overflow-hidden aspect-square">
                    <img
                      ...
                      loading="lazy"
                    />
                    <div className="absolute inset-0 bg-black/20 hover:bg-black/0 transition" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className={`space-y-6 sm:space-y-8 transition-all duration-700 delay-200 ${
              ...
              <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                {luxuryFeatures.map((feature, idx) => (
                  <div
                    key={feature.title}
                    className={`glass-card rounded-xl p-4 hover:scale-102 transition-all duration-300 group cursor-default`}
              ...
              <div className="glass rounded-xl p-4 sm:p-5">
                ...
                <div className="flex flex-wrap gap-3">
                  {['Personal Shopper', 'Private Viewing', 'Chauffeur Service', 'International Shipping'].map((service, idx) => (
                    <span key={service} className="text-sm text-gray-300 flex items-center gap-1">
