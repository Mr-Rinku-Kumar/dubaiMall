  ...
  return (
    <div className="bg-black min-h-screen pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className={`text-center mb-12 sm:mb-16 transition-all duration-700 ${
        ...
        <div ref={audienceRef}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16 md:mb-20">
            {audienceData.map((data, i) => (
              <div
                key={data.segment}
                className={`glass-card rounded-2xl p-4 sm:p-6 text-center hover:scale-105 transition-all duration-300 ${
                  hasAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
        ...
        <div ref={sponsorsRef}>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8">
            {pastSponsors.map((sponsor, i) => (
              <div
                key={sponsor}
                className={`text-gray-400 text-sm sm:text-base md:text-lg font-medium hover:text-white transition cursor-pointer ${
        ...
        <div ref={ctaRef}>
          <div className={`mt-12 sm:mt-16 md:mt-20 text-center transition-all duration-700 delay-500 ${
            hasAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
